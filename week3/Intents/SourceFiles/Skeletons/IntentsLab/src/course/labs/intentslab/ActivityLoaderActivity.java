...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		this.startActivityForResult(explicitIntent, 90);
	...
	private void startImplicitActivation() {
        ...
        chooserIntent = new Intent(Intent.ACTION_VIEW,Uri.parse("http://www.google.com"));
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode==RESULT_OK && requestCode==90)
		{
			if (data.hasExtra("results")){
				...
				mUserTextView.setText(data.getExtras().getString("results"));
				Log.i(TAG,"The data:" + data.getExtras().getString("results"));
